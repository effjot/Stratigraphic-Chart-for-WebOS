...
(defparameter *data*
  '((phanerozoic "Phanero&shy;zoic" nil nil nil "Literally, &ldquo;visible animal live&rdquo;, as larger lifeforms with hard shells and skeletons developed and left visible fossils.")
    ...
    (quaternary "Quaternary" nil nil nil "The most recent period, marked by alternating glaciations (ice ages) and interglacials, and generally cooler than the preceding Neogene (Tertiary).")
    ...
    (pliocene "Pliocene" nil nil nil "Cooler climate than in the preceding period, but no glaciations yet.  The isthmus of Panama linked North and South America, changing oceanic circulation patterns.")
    (piacenzian "Piacenzian" 3.600 (digits 3) gssp)
    (zanclean "Zanclean" 5.322 (digits 3) gssp)
    (miocene "Miocene" nil nil nil "The Thetys ocean finally closed; orogenesis took place e.g. in the Alps, Himalaya and Andes.  Climate was cooler than in the preceding period.  Various lignite (brown coal) deposits formed in Central Europe.")
    ...
    (cretaceous "Cretaceous" nil nil nil "Named after the Latin word for chalk, the carbonate sediment of which vast amounts were formed.  The northern Atlantic ocean widened, and Gondwana broke up into the modern southern continents.  This period ends with a large mass extinction; amongst a lot of other species, dinosaurs disappeard, allowing mammals to become dominant in the following Cenozoic era.")
    ...
    (jurassic "Jurassic" nil nil nil "Named after the Jura mountains, which consist mainly of limestone.  The northern and southern parts of Pangea (Laurasia and Gondwana) separated, and the northern Atlantic ocean opened.  Dinosaurs dominated this period, and plants throve after the arid Triassic climate changed to more humid conditions.")
    ...
    (triassic "Triassic" nil nil nil "Means &ldquo;triplet&rdquo;: named after its appearance in Germany &ndash; coloured sandstones, shelly limestones, shales.  Land consisted mainly of the single supercontinent Pangea (which started to break apart), surrounded by a large ocean, Panthalassa.  The climate was arid.  Flora and fauna recovered after the large extinction marking the beginning of the Triassic; seed plants became dominant, and the dinosaurs appeared.")
    ...
    (permian "Permian" nil nil nil "Named after the Perm region of Russia, where its rocks where first described.  In the early Permian, the major land masses collided and formed the  supercontinent Pangea, surrounded by a large ocean, Panthalassa.  Climate changed from glaciation to hot and dry conditions during the course of the Permian.")
    (lopingian "Lopingian")
    ...
    (carboniferous "Carboni&shy;ferous" nil nil nil "")
